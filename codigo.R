...
#sacar nuevo dataset con las columnas que nosotros escojamos
...
write.csv(datasetnuevo,"~/8 SEMESTRE/CIENCIA DE DATOS/proyectociencia/datasetnuevo.csv")
View(datasetnuevo)
